...
var Bot = /** @class */ (function () {
    ...
    Bot.prototype.replyInvalid = function () {
        return __awaiter(this, void 0, void 0, function () {
            var members, issue, opener, mark, issueComment;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        console.log(members);
                        if (!!issue.body.includes(mark)) return [3 /*break*/, 5];
                        issueComment = this.context.issue({ body: string_template_1.default(replys_1.replays.invalid, { user: opener }) });
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.context.github.issues.addLabels(this.context.issue({ labels: ['Invalid'] }))];
                    case 4:
                        _a.sent();
                        _a.label = 5;
