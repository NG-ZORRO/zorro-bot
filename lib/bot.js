...
var Bot = /** @class */ (function () {
    ...
    Bot.prototype.replyInvalid = function () {
        return __awaiter(this, void 0, void 0, function () {
            var invalidConfig, isMember, issue, opener, mark, labels, issueComment;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        invalidConfig = this.config.issue.invalid;
                        return [4 /*yield*/, this.isMember()];
                    case 1:
                        isMember = _a.sent();
                        issue = this.context.payload.issue;
                        opener = issue.user.login;
                        mark = invalidConfig.mark;
                        labels = [];
                        ...
                        issueComment = this.context.issue({ body: string_template_1.default(invalidConfig.replay, { user: opener }) });
